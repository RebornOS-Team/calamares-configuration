...
#ifndef CONDITIONALPACKAGECHOOSERVIEWSTEP_H
#define CONDITIONALPACKAGECHOOSERVIEWSTEP_H
...
CALAMARES_PLUGIN_FACTORY_DECLARATION( ConditionalPackageChooserViewStepFactory )

#endif  // CONDITIONALPACKAGECHOOSERVIEWSTEP_H
